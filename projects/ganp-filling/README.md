...
# Application of data in the soiling model

With all the data generated, it was possible to compare their performance in the HSU dirtiness model, which uses particulate matter parameters as input. The results showed that the Transformer generation model had a slight advantage in predicting dirtiness in photovoltaic systems, presenting lower MAE and RMSE than the XGBoost and LSTM models for Dracena, and similar performance to XGBoost in Brasília, with an advantage over LSTM.

## Brasília:
### Error metrics:
<img width="1189" height="590" alt="image" src="https://github.com/user-attachments/assets/7782c52f-b1ee-4249-ac1e-7595a9670548" />
Soiling Ratio:
<img width="1590" height="690" alt="image" src="https://github.com/user-attachments/assets/08712984-9d5d-4bff-9160-75aef4798a3e" />

## Dracena:
<img width="1189" height="590" alt="image" src="https://github.com/user-attachments/assets/8e98123f-22f3-4aaf-b06f-e866e552c4db" />
Soiling Ratio:
<img width="1590" height="690" alt="image" src="https://github.com/user-attachments/assets/6b24f597-2b4c-4365-aa0f-650ec6fcf759" />

## Final Conclusions:
The Transformer model is very robust and can satisfactorily predict dirt dynamics over time in daily averages. The LSTM model can also capture dynamics in a similar way over time, with slight differences in peaks, where the transformer has an advantage, as shown in the RMSE error graph, which penalizes larger errors at peaks. The XGBoost model was faster to train, making it a more accessible and reliable alternative for predicting this data. In short, it is possible and feasible to use generative models to predict dirt data, since the gains generated by improved accuracy in loss estimates for a plant justify the investment in this type of analysis.
...
Kimber, A., Mitchell, L., Nogradi, S., and Wenger, H. (2006). ”The Effect of Soiling on Large Grid Connected Photovoltaic Systems in California and the Southwest Region of the United States.” Proceedings of the IEEE 4th World Conference on Photovoltaic Energy Conference (WCPEC-4), Waikoloa, HI, USA, 2391–2395.

M. Coello and L. Boyle. (2018). “Simple Model For Predicting Time Series Soiling of Photovoltaic Panels,” in IEEE Journal of Photovoltaics.
