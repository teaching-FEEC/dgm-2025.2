...
#     def __init__(self,  nf=55, num_modules=6):
#         super(DCTB, self).__init__()
#         self.B1 = B.LSAB(in_channels=nf)
#         self.B2 = B.LSAB(in_channels=nf)
#         self.B3 = B.LSAB(in_channels=nf)
#         self.B4 = B.LSAB(in_channels=nf)
#         self.B5 = B.LSAB(in_channels=nf)
#         self.B6 = B.LSAB(in_channels=nf)
...
#         out_B10 = torch.cat([input, out_B1], dim=1)
#         out_B11 = self.c1(out_B10)
#
#         out_B2 = self.B2(out_B11)
#         out_B20 = torch.cat([out_B10, out_B2], dim=1)
