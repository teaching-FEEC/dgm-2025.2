...
Implementou-se o **Smart Chopping com Overlap Adaptativo**, uma melhoria que ajusta dinamicamente o overlap do chopping baseado na complexidade local da imagem. Esta feature melhora **tanto velocidade quanto qualidade** sem aumentar significativamente o uso de memória.
...
3. **`app.py`** (MODIFICADO)
   ...
   - Integração junto a interface Gradio
...
<img width="743" height="243" alt="image" src="https://github.com/user-attachments/assets/9b7b18af-bb5a-48fb-8dd0-37c08a7dbe88" />


New Architecture:

<img width="742" height="411" alt="image" src="https://github.com/user-attachments/assets/9f8aa1b7-81e8-4cb8-bfbb-b88c53377b5b" />


Now we'll expand each one topic added to our new model.

## ADAPTIVE_SCHEDULER
### 1. **Visão Geral**
- Ajusta dinamicamente o número e espaçamento de timesteps
- Baseado na análise de complexidade da imagem
- Objetivo: Otimizar qualidade vs velocidade

### 2. **Como Funciona**

#### 2.1. **Entrada**
- Score de complexidade: [0, 1]
- Timesteps originais: [200, 100, 50] (exemplo)
- Número base de steps: 3

#### 2.2. **Ajuste por Complexidade**

**Baixa Complexidade (< 0.3)**
- Número de steps: Mantém base (3 steps)
- Espaçamento: Mais espaçado
- Exemplo: [200, 80, 30]
- Resultado: Mais rápido, qualidade similar

**Média Complexidade (0.3 - 0.6)**
- Número de steps: Base + 1 (4 steps)
- Espaçamento: Normal
- Exemplo: [200, 150, 100, 50]
- Resultado: Balanceado

**Alta Complexidade (> 0.6)**
- Número de steps: Base + 2 (5-6 steps)
- Espaçamento: Mais próximo (tighter)
- Exemplo: [250, 220, 180, 140, 100, 60]
- Resultado: Máxima qualidade
