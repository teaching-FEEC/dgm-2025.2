...
def _fetch_class_library_tuple(module):
    ...
    # Handle case where diffusers is in a subdirectory (e.g., src/diffusers)
    module_name_parts = __name__.split(".")
    # Try to find 'diffusers' in the module path, or use the first part
    if 'diffusers' in module_name_parts:
        diffusers_module_name = 'diffusers'
    else:
        diffusers_module_name = module_name_parts[0]
    diffusers_module = importlib.import_module(diffusers_module_name)
